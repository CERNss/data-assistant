...
Image publishing is tag-driven. Push a release tag to build and push both
service images:
...
Main branch pushes and pull requests into `main` run tests only; they do not
publish Docker images. Release tags also publish `latest`.
