...
class TestLoggerChatImageConfig(unittest.TestCase):
    ...
    def test_defaults(self) -> None:
        ...
        os.environ.pop("CHAT_IMAGE_NATS_STREAM_MAX_AGE_SEC", None)
        os.environ.pop("CHAT_IMAGE_NATS_STREAM_MAX_BYTES", None)
        os.environ.pop("CHAT_IMAGE_NATS_STREAM_MAX_MSGS", None)
        ...
        self.assertEqual(cfg.nats.stream_max_age_sec, 604800.0)
        self.assertEqual(cfg.nats.stream_max_bytes, -1)
        self.assertEqual(cfg.nats.stream_max_msgs, -1)
...
class TestProcessorChatImageConfig(unittest.TestCase):
    ...
    def test_defaults(self) -> None:
        ...
        self.assertEqual(cfg.nats.nak_delay_sec, 5.0)
        self.assertEqual(cfg.nats.stream_max_age_sec, 604800.0)
        self.assertEqual(cfg.nats.stream_max_bytes, -1)
        self.assertEqual(cfg.nats.stream_max_msgs, -1)
